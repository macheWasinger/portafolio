        ...
        <div className="container-padre__Contactos">
            ...
            <div className="container-hijo__contactos">
                <div className="container__title-lineaHorizontal">
                    ...
                    <div className="title-lineaHorizontal__contactos" data-aos="slide-left" data-aos-duration="1000" data-aos-offset="200">
                    </div>
                </div>
            ...
            <div className="container__site-footer">
                ...
                <div className="container-datos__siteFooter">
                    <img src={logo} alt=""/>
                    <p className="style__text-desarrollador">© 2021 Creado por Marcelo Adrián Wasinger</p>
                </div>
            </div>
        </div>
    )
