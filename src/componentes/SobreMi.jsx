...
import smallImage from '../img/maw2.png';
        ...
        <div className="container-padre_sobreMi">
            ...
            <div className="container_small-picture">
                <div className="container-image">
                    <img src={smallImage} className="style-smallImage" 
                    data-aos="fade-down-right"
                    data-aos-duration="750" data-aos-offset="250" alt="" />
                </div>
            </div>
            <div className="container-text_sobreMi">
                ...
                <a download="CV-MarceloWasinger" href={cv} className="style-button-descargarCV">Descargar CV</a>
            </div>
        </div>
    )
}
